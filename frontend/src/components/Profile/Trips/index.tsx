...
const Trips = ({ bookedApartments }: Props) => {
  return (
    <div>
      <h2 className="text-2xl font-semibold text-gray-800 mb-4">Past Trips</h2>
          ...
          bookedApartments.map((booking, idx) => (
            ...
            >
              ...
              <div className="p-6 space-y-4">
                ...
                <p className="text-gray-500">{booking.apartment.location}</p>
                ...
                <div className="text-sm text-gray-600">
                  ...
                  <p>
                    End Date:{" "}
                    {new Date(booking.bookedDates.endDate).toLocaleDateString()}
                  </p>
                </div>
